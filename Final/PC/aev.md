...
## Save Event
<img align="right" src="images/Events/Save Event.png" width = 200 height = 200></img> The save event allows the player to save their progress. There is only one parameter for this event type and that is terminal number. It is currently unknown what the parameter modifies. <br><br> <br><br> <br><br>
