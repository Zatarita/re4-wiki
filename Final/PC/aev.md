...
## Flag Event
<img align="right" src="images\Events\Flag Event.png" width = 200 height = 200></img> <img align="right" src="images\Events\Flag Event - Toggled.png" width = 100 height = 100></img> The Flag event is used to modify a flag stored in memory. The event is able to [toggle on or off](#flag-action) a specific [flag number](#flag-number) from one of the [Room flags, Room-Save Flags, and Scenario flags](#flag-id). <br><br><br>
